      ...
      <>
        ...
        <div
          ...
          className={`hidden md:flex ${
            layout === "horizontal" ? "items-center" : "flex-wrap items-center"
          } gap-2 ${className}`}
        >
          <button
          ...
          <button
            ...
            aria-label={
              activeFilters.size === allTypes.length
                ? "Hide all evidence types"
                : "Show all evidence types"
            }
          >
            {activeFilters.size === allTypes.length ? "Hide All" : "Show All"}
          </button>
        </div>
        {/* Mobile dock */}
        <div
          ...
          >
            ...
            >
              <path
                ...
                d="M4.5 12a7.5 7.5 0 0112.82-5.303L21 10M4.5 12a7.5 7.5 0 0012.82 5.303L21 14M4.5 12H3"
              />
            </svg>
          ...
          >
            ...
            >
              <path
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M12 18.25v2.25m0-2.25a7.5 7.5 0 100-15 7.5 7.5 0 000 15z"
              />
            </svg>
            ...
            {activeFilters.size === allTypes.length ? (
              ...
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M3.98 8.223A10.477 10.477 0 0112 6c2.5 0 4.8.855 6.62 2.223M4 8l8 8m8-8l-8 8"
                />
              </svg>
            ) : (
              <svg
