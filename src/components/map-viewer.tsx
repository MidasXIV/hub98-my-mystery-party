      ...
      <div className="relative w-full max-w-[800px] min-h-[900px] map-clean-paper flex flex-col border border-gray-300">
          ...
          {data.markers.map((marker, i) => (
            <div
              ...
              className={`absolute map-pin ${
                marker.showLabel === true ? "map-pin-label" : ""
              } ${
                marker.type === "crime"
                  ? "pin-crime"
                  : marker.type === "suspect"
                    ...
                    : marker.type === "clue"
                      ? "pin-clue"
                      : "pin-location"
              } ${marker.showLabel === true ? "text-[9px]" : "text-sm"}`}
              style={{ left: `${marker.x}%`, top: `${marker.y}%` }}
              title={marker.label}
            >
              {marker.showLabel ? marker.label : i + 1}
            </div>
          ))}
          ...
          <div className="absolute top-4 right-4 pointer-events-none opacity-80">
            <svg width="40" height="40" viewBox="0 0 100 100">
              ...
              <text
                ...
                y="-10"
                textAnchor="middle"
                className="font-header font-bold text-xs"
              >
                N
              </text>
            </svg>
        ...
        <div className="flex-1 p-8 bg-white">
          <div className="flex items-center gap-2 mb-6 border-b-2 border-black pb-2">
            ...
            <h2 className="font-header text-xl uppercase tracking-wide">
              Points of Interest
            </h2>
          </div>
