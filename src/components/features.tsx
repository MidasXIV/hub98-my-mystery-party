...
const features = [
  {
    ...
    description: 'No downloads, no printing. Start your investigation the moment you purchase.',
    icon: 'play',
    type: 'iconCard',
  },
  {
    title: 'Immersive Experience',
    description: 'Feel like a real detective with high-quality photos, audio clips, and realistic documents.',
  ...
  },
  {
    ...
    description: 'Use our dynamic timeline and evidence board to connect the dots and track suspect movements.',
  ...
  },
  {
    ...
    description: 'Invite friends to your private investigation room. Share theories and crack the case as a team.',
    imageUrl: '/features_section/party.png',
    type: 'imageCard'
  },
  {
    title: 'All Your Evidence',
    description: 'Police reports, witness interviews, crime scene photos—all organized in one place.',
  ...
  },
  {
    ...
    description: 'Feeling stuck? Get a nudge in the right direction with our tiered hint system. No spoilers.',
    icon: 'lightbulb',
    type: 'iconCard'
  },
  {
    title: 'New Cases Added',
    description: 'A growing library of mysteries means your next thrilling investigation is always waiting.',
    icon: 'plus',
    type: 'iconCard'
  },
  {
    title: 'Join 50K+ Detectives',
    description: 'Become part of a thriving community of sleuths who have successfully closed cases on our platform.',
    type: 'statCard'
  },
];
            ...
            <div className="group relative aspect-[4/5] bg-surface rounded-3xl overflow-hidden shadow-lg transition-transform duration-300 ease-in-out hover:-translate-y-2">
                ...
                <div className="absolute bottom-0 left-0 p-6 text-white flex flex-col justify-end h-full">
                    <div>
                        ...
                        <p className="mt-2 text-white/80 text-sm leading-relaxed">{feature.description}</p>
                    </div>
                </div>
            </div>
        );
    ...
    if (feature.type === 'statCard') {
        return (
            <div className="bg-surface-accent p-8 rounded-3xl flex flex-col justify-center items-center aspect-[4/5] text-center transition-transform duration-300 ease-in-out hover:-translate-y-2">
                <h3 className="text-5xl md:text-6xl font-bold text-text-primary">50K+</h3>
                <p className="mt-2 text-text-secondary font-semibold">Detectives</p>
                <p className="mt-4 text-text-secondary text-sm leading-relaxed">{feature.description}</p>
            </div>
        );
    }
...
function Features() {
    ...
    return (
        <section ref={sectionRef} className="bg-surface text-text-primary py-24 md:py-32 font-sans">
