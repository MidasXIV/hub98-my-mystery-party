    ...
    <div className="min-h-screen w-full overflow-x-hidden bg-background text-foreground">
      ...
      >
        {userId ? (
          ...
          <main className="flex min-h-screen w-full items-center justify-center bg-[radial-gradient(circle_at_top,_rgba(255,255,255,0.08),_transparent_40%),linear-gradient(135deg,_rgba(17,24,39,0.98),_rgba(3,7,18,1))] px-6 text-white">
