...
export const mysteryKits: MysteryKit[] = [
  {
    ...
    seoKeywords: [
      ...
      "virtual murder mystery kit",
      "Valentine’s Mixer: Swipe for Murder",
      "My Mystery Party",
      "Zoom murder mystery games",
      "4 to 20 player murder mystery",
      "mobile-optimized murder mystery",
      "digital forensic reports",
      "virtual social mixer",
      "Valentine's Day party ideas",
      "hosting a murder mystery online",
      "character-driven roleplay",
      "interactive online games",
      "remote team building activities",
      "Amorville murder mystery",
      "icebreaker games for adults",
      "paperless party games",
      "My Mystery Party review",
