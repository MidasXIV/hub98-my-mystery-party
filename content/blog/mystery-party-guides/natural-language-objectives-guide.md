---
slug: natural-language-objectives-guide
title: "Mastering Objectives with Natural Language"
description: "No commands needed—learn how to use plain English to complete objectives, cross‑reference evidence, and reveal hidden clues."
date: 2025-12-24
...
1. Open the Objectives panel.
2. Pick one objective—stay focused until it’s resolved.
3. Use summaries and comparisons to quickly orient.
4. Ask for contradictions to validate or debunk claims.
5. Mark the objective complete and move to the next.
